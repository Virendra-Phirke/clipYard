...
export default function NotFound() {
  return (
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '32px', textAlign: 'center', color: '#161d1a' }}>
      <div>
        ...
        <p style={{ marginTop: '16px', color: '#3e4944', fontSize: '16px', lineHeight: '1.5' }}>
          The page you are looking for does not exist. Return to the homepage to create a new ClipYard room.
        </p>
        <a href="/" style={{ marginTop: '24px', display: 'inline-block', color: '#006a53', textDecoration: 'underline', fontFamily: 'JetBrains Mono, monospace' }}>
          Back to home
        </a>
      </div>
    </div>
